...
function Timelinee() {
  ...
  >
    ...
    <h4>
      ...
      Eligibility: All undergraduate students, pursuing a full-time degree in any branch <br />
      Team size: 1-2 <br />
  ...
  >
    ...
    <h4>
      ...
      (No penalty for wrong submissions and tie breaks are based on time of submission(Last AC)) <br />
  ...
  >
    ...
    <h4>
      The onsite round for the Turing Cup 2023 for the qualified teams of Round-1. <br />
      ...
      (Penalty of 1 for wrong submissions and the leaderboard will be freezed during the final 30 minutes) <br />
    </h4>
  </VerticalTimelineElement>
  <VerticalTimelineElement 
    className="vertical-timeline-element--work"
  ...
  >
    ...
    <h4>
      The third and final round (Onsite) of Turing Cup 2023 coding contest <br />
      Date: 25/03/2023 - Saturday <br />
      Time: 13:45 - 16:30 <br />
      Platform: TBD <br />
      Location: VNR VJIET Campus, Bachupally, Hyderabad <br />
