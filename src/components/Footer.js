  ...
  return (
    <Box sx={{my:2}}>
        ...
        <Grid container spacing={0}>
            <Grid item xs={12} md={9} sx={{my:2, textAlign: {xs: 'center', md: 'left'}}}>
                <Typography variant="body2" component="div" sx={{ flexGrow: 1, color: "#757575" }}>“The most damaging phrase in the language is.. it's always been done this way” - Grace Hopper</Typography>
            </Grid>
